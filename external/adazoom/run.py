"""External execution template for AdaZoom on HRP4K."""
...
def main():
    parser = argparse.ArgumentParser(description="AdaZoom HRP4K Runner")
    ...
    print(f"[AdaZoom Adapter] Running AdaZoom on {args.split} with {args.weights}...")
    return 0
