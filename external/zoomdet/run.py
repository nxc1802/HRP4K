"""External execution template for ZoomDet on HRP4K."""
...
def main():
    parser = argparse.ArgumentParser(description="ZoomDet HRP4K Runner")
    ...
    print(f"[ZoomDet Adapter] Running ZoomDet on {args.split} with {args.weights}...")
    return 0
