...
\vspace{-0.5em}
\section{Research Narrative \& The Perspective-Aware Paradigm}
\label{sec:narrative}
...
\noindent
In standard driving perspectives, the camera view exhibits severe non-uniform spatial utility: the upper sky and background region occupies $\sim 45\text{--}50\%$ of the canvas with zero pothole utility, whereas the distant road region undergoes extreme perspective compression where potholes shrink below 10 pixels. \textbf{ZoomDet} introduces a continuous, differentiable perspective grid transformation that redistributes the fixed $640 \times 640$ canvas towards distant road areas, restoring spatial gradients without generating tile-boundary artifacts.

\begin{figure}[H]
\centering
\resizebox{\textwidth}{!}{
\begin{tikzpicture}[node distance=1.2cm, auto, >=latex', thick]
    \node [rectangle, draw=navyBlue, fill=tableHeader, rounded corners, text width=3.4cm, text centered, minimum height=1.3cm] (res) {\textbf{1. Resolution Dilemma}\\ 4K: 55.28\% @ 32.5ms\\ 640: 37.37\% (-18 pp)};
    ...
    \node [rectangle, draw=navyBlue, fill=tableHeader, rounded corners, text width=3.5cm, text centered, minimum height=1.3cm, right=0.6cm of slice] (geom) {\textbf{3. Perspective Prior}\\ Sky wastes 50\% area;\\ Continuous Grid Warp};
    \node [rectangle, draw=paretoGreen, fill=green!15, rounded corners, text width=3.5cm, text centered, minimum height=1.3cm, right=0.6cm of geom] (prop) {\textbf{4. Proposed ZoomDet}\\ \textbf{42.07\% mAP @ 22.0ms}\\ \textbf{104$\times$ Faster than Slicing}};
...
\caption{The 4-stage research story pipeline: from resolution dilemma to continuous deformation warp.}
\label{fig:pipeline}
\end{figure}
...
\begin{subfigure}[b]{0.49\textwidth}
    ...
    \caption{\textbf{Fig. 1}: 4K $\to$ 640 Resolution Bottleneck \& Scale Loss.}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/fig2_accuracy_latency_pareto.png}
    \caption{\textbf{Fig. 2}: Accuracy--Latency Pareto Optimal Frontier.}
\end{subfigure}
...
\begin{subfigure}[b]{0.49\textwidth}
    ...
    \caption{\textbf{Fig. 3}: Scale-Wise AP Comparison across Strategies.}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/fig4_efficiency_vram_flops.png}
    \caption{\textbf{Fig. 4}: 3-Panel Resource Footprint Comparison.}
\end{subfigure}

\vspace{1.0em}
\begin{subfigure}[b]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/fig5_pavement_robustness.png}
    \caption{\textbf{Fig. 5}: Pavement Material Robustness: Asphalt vs. Concrete.}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/training_loss_and_metrics_convergence.png}
    \caption{\textbf{Fig. 6}: 150-Epoch Training Convergence \& Loss Dynamics.}
\end{subfigure}
\caption{Comprehensive visual evidence for the HRP4K benchmark and proposed Warped ZoomDet framework.}
